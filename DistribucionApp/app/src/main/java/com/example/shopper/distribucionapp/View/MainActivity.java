        ...
        DirectionFinderListener
{
    ...
    ListaDespachoEntity listaDespachoEntity=new ListaDespachoEntity();
    ...
    private void GuardarGeolocalizacion()
    {
        ...
        final String Company=listaDespachoEntity.company;
        final String ShiptoNum=listaDespachoEntity.shiptonum;
        final String CustNum=listaDespachoEntity.custnum;

        //final String date=String.valueOf(new SimpleDateFormat("yyyy-MM-dd").format(listaDespachoEntity.fecha));
        //final String date=String.valueOf((listaDespachoEntity.fecha));
        final String Latitud=String.valueOf(latitud);
        final String Longitud=String.valueOf(longitud);
        final String Custid=listaDespachoEntity.custid;
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                resultado=listaDespachoDao.ActualizarLocalizacionCliente(Company,Latitud,Longitud,ShiptoNum,CustNum);

                //listaDespachoDao.ActualizarLocalizacionCliente("C001","10378592","2018-04-05","1","1","2010011183");
    ...
    private void sendRequest()
    {
        ...
        //listaDespachoEntity.longitud.replace(',','.');
        Deslatitud=listaDespachoEntity.latitud.replace(",",".");
        Deslongitud=listaDespachoEntity.longitud.replace(",",".");

        String destination = Deslatitud+","+Deslongitud;
