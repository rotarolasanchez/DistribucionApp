...
public class IndicatorNCDView extends AppCompatActivity implements View.OnClickListener{
    private PieChart pieChart;
    private BarChart barChart;
    private String [] months=new String []{"Entregado","Programado","Re-programado","Anulado"};
    private String [] Indices=new String []{"Total","Entregado"};
    private String [] Indices2=new String []{"Entregado","Diferido"};
    ...
    private ArrayList<BarEntry>getBarEntries()
    {
        ...
        Prevalor1=TotalEntregado;
        //Prevalor1=(TotalFueradePlazo/TotalGeneral)*100;
...
/*        for(int i=0;i<Eindicator.size();i++)
    ...
    {
      barChart=(BarChart)getSameChart2(barChart,"Nivel de Cumpliento de Despachos ",Color.RED,Color.CYAN,3000);
                        //+(Indice())*100
        ...
        pieChart=(PieChart)getSameChart(pieChart,"Nivel de Cumpliento de Despachos Requerido: 94%",Color.GRAY,Color.MAGENTA,3000);
